...
program p
  ...
  ! CHECK:     %[[V_37:[0-9]+]] = llvm.call_intrinsic "llvm.get.rounding"() : () -> i32
  ...
  ! CHECK:     %[[V_51:[0-9]+]] = llvm.call_intrinsic "llvm.get.rounding"() : () -> i32
  ...
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_59]]) fastmath<contract> : (i32) -> ()
  ! CHECK:     %[[V_60:[0-9]+]] = fir.call @llvm.nearbyint.f32(%[[V_50]]) fastmath<contract> : (f32) -> f32
  ! CHECK:     %[[V_61:[0-9]+]] = fir.convert %[[V_60]] : (f32) -> f32
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_51]]) fastmath<contract> : (i32) -> ()
...
! print*, x, ' -> ', y, ' -> ', n
  ...
  ! CHECK:     %[[V_71:[0-9]+]] = llvm.call_intrinsic "llvm.get.rounding"() : () -> i32
  ...
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_79]]) fastmath<contract> : (i32) -> ()
  ...
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_71]]) fastmath<contract> : (i32) -> ()
  ...
  ! CHECK:     %[[V_86:[0-9]+]] = llvm.call_intrinsic "llvm.get.rounding"() : () -> i32
  ...
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_94]]) fastmath<contract> : (i32) -> ()
  ...
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_86]]) fastmath<contract> : (i32) -> ()
...
! print*, x2, ' -> ', y2, ' -> ', n8
  ...
  ! CHECK:     %[[V_112:[0-9]+]] = llvm.call_intrinsic "llvm.get.rounding"() : () -> i32
  ...
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_120]]) fastmath<contract> : (i32) -> ()
  ...
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_112]]) fastmath<contract> : (i32) -> ()
...
! print*, x3, ' -> ', y3, ' -> ', n16
  ...
  ! CHECK:     %[[V_146:[0-9]+]] = llvm.call_intrinsic "llvm.get.rounding"() : () -> i32
  ...
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_154]]) fastmath<contract> : (i32) -> ()
  ! CHECK:     %[[V_155:[0-9]+]] = fir.call @llvm.nearbyint.f32(%[[V_145]]) fastmath<contract> : (f32) -> f32
  ! CHECK:     %[[V_156:[0-9]+]] = fir.convert %[[V_155]] : (f32) -> f32
  ! CHECK:     llvm.call_intrinsic "llvm.set.rounding"(%[[V_146]]) fastmath<contract> : (i32) -> ()
